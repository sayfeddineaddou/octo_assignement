...
class TrainingPipeline:
    ...
    def get_model_perfomance(self) -> tuple:
        ...
        return accuracy_score(self.y_test, predictions),precision_score(self.y_test, predictions),\
            recall_score(self.y_test, predictions), f1_score(self.y_test, predictions)
